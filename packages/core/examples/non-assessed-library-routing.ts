    ...
    routes: [
      {
        ...
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["wait"], ["waits"], ["waiting"], ["average"], ["long"], ["delay"], ["slow"], ["quickly"], ["response", "time"]],
          noneTerms: ["slip", "slips", "why", "mean", "means", "definition", "defined", "complain", "complaints", "complained", "specialist", "clerk"],
        },
        prerequisiteFactIds: [],
      ...
      },
      {
        ...
        priority: 10,
        match: {
          anyPhrases: ["response time", "handling time", "baseline", "median", "wait", "waits", "average", "typical"],
          allTerms: [],
          anyTermGroups: [],
          noneTerms: ["mean", "means", "definition", "defined", "measured", "counted", "slip", "slips", "specialist", "clerk"],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        releasedEvidenceIds: [],
      ...
      },
      {
        ...
        match: {
          ...
          anyTermGroups: [
            ...
            ["what", "happens"], ["steps"], ["flow"], ["walk", "through"], ["how", "questions"],
            ["go", "to"], ["goes", "to"], ["collect", "slips"], ["collects"], ["collected"],
            ["decide", "which"], ["decide", "specialist"], ["escalate"], ["escalated"], ["on", "a", "slip"],
            ["answer", "directly"], ["cannot", "answer"], ["can", "answer"],
          ],
          noneTerms: ["accuracy", "accurate", "budget", "staff", "specialists", "day", "daily", "hours", "computer", "software", "system", "who"],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        releasedEvidenceIds: [],
      ...
      },
      {
        ...
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["mean"], ["means"], ["definition"], ["defined"], ["measured"], ["counted"]],
          noneTerms: ["median", "average", "number", "longest", "shortest"],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        releasedEvidenceIds: [],
      ...
      {
        id: "ask-manager-specialist-wait",
        channel: "persona",
        targetId: "library-manager",
        priority: 11,
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["specialist", "wait"], ["specialist", "long"], ["specialist", "take"], ["specialist", "takes"], ["slip", "wait"], ["slip", "long"]],
          noneTerms: ["accuracy", "accurate", "hours", "who", "collect", "often"],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        releasedEvidenceIds: [],
        consequence: {
          id: "manager-specialist-wait-answer",
          time: { amount: 10, unit: "minutes" },
          resources: [],
          evidenceOutcome: "release",
        },
        outcome: {
          ...
          factIds: ["median-wait"],
          studentMessage:
            "Morgan: nobody has timed specialist answers separately. The only number is the log's 18-minute median for any first response, clerk or specialist.",
        },
      },
      {
        id: "ask-manager-volume",
        channel: "persona",
        targetId: "library-manager",
        priority: 12,
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["per", "day"], ["daily"], ["volume"], ["how", "many", "questions"], ["busy"], ["per", "week"]],
          noneTerms: [],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        ...
        outcome: {
          ...
          factIds: [],
          studentMessage:
            "Morgan does not count questions at the desk. The only record is the frozen 20-question sample in the desk log; treat volume as unknown.",
        },
      },
      {
        id: "ask-manager-details",
        channel: "persona",
        targetId: "library-manager",
        priority: 12,
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["hours"], ["who", "is"], ["schedule"], ["computer"], ["software"], ["system"], ["equipment"], ["rota"], ["shift"]],
          noneTerms: [],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        ...
        outcome: {
          ...
          factIds: [],
          studentMessage:
            "Morgan can describe the process but has nothing to share about the specialist's hours or identity or the desk's equipment. Treat those as unknown.",
        },
      },
      {
        id: "ask-log-split",
        ...
        match: {
          anyPhrases: [],
          allTerms: [],
          anyTermGroups: [["specialist"], ["clerk"], ["share"], ["split"], ["proportion"], ["percent"], ["passed"], ["routed"]],
          noneTerms: [],
        },
        prerequisiteFactIds: [],
        prerequisiteEvidenceIds: [],
        ...
        outcome: {
          ...
          factIds: [],
          studentMessage:
            "The log does not record whether the clerk or the specialist answered, so it cannot split questions or times between them.",
        },
      },
      {
        id: "ask-log-accuracy",
